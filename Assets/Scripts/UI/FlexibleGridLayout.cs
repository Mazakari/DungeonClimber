...
public class FlexibleGridLayout : LayoutGroup
{
    ...
    public override void CalculateLayoutInputHorizontal()
    {
        ...
        for (int i = 0; i < rectChildren.Count; i++)
        {
            ...
            var xPos = (_cellSize.x * columnCount) + (_spacing.x * columnCount) + (_spacing.x * columnCount) + padding.left;
            var yPos = (_cellSize.y * rowCount) + (_spacing.y * rowCount) + (_spacing.y * rowCount) + padding.top;
